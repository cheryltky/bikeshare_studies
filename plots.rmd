...
```
##### Aim: Identify areas to improve current subscription model feasibility for Blue Bikes(Boston) and Divvybikes (Chicago) and drive acquisition of new subscribers.
...
##### 2. Subscription Segments
```{r subscriptions, echo=FALSE}
dat2 <- read.csv("https://raw.githubusercontent.com/cheryltky/bikeshare_studies/main/csvdata/q2.csv", sep = ",", header=T)
...
library(ggplot2)
#barplot
ggplot(dat2,aes(x=segment,y=user_count,color=as.factor(year))) +
