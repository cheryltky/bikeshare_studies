...
```
##### Aim: DFetermine current subscription model feasibility for Blue Bikes(Boston) and Divvybikes (Chicago) and drive acquisition of new subscribers.
...
#barplot
ggplot(dat2,aes(x= year,y=user_count, fill=as.factor(segment))) + geom_bar(position ="dodge", stat="identity")
